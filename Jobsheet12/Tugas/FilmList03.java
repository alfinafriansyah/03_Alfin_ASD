...
public class FilmList03 {
    ...
    public void tambahDataAwal(String id, String judul, double rating) {
        Film03 newFilm = new Film03(id, judul, rating);
        if (head == null) {
            head = tail = newFilm;
        } else {
            newFilm.next = head;
    ...
    public void urutDataRatingDESC() {
        ...
        for (Film03 current = head; current != null; current = current.next) {
            for (Film03 index = current.next; index != null; index = index.next) {
