...
public class BinaryTree03 {
    ...
    public Node03 addRecursive(Node03 current, int data) {
        if (current==null) {
    ...
    public Node03 getSuccessor(Node03 delNode) {
        Node03 successorParent = delNode;
        Node03 successor = delNode;
        Node03 current = delNode.right;
        while (current != null) {
    ...
    public void displayLeafData(Node03 node) {
        if (node == null) {
            return;
        }
    ...
    public int countLeafNodesRekursif(Node03 node) {
        if (node == null) {
            return 0;
        }
        if (node.left == null && node.right == null) {
